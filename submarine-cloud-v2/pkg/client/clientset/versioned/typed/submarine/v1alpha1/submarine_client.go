...
import (
	...
	"github.com/apache/submarine/submarine-cloud-v2/pkg/client/clientset/versioned/scheme"
...
func (c *SubmarineV1alpha1Client) Submarines(namespace string) SubmarineInterface {
	return newSubmarines(c, namespace)
}
