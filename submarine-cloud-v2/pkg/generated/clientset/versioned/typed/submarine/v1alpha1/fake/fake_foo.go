...
var foosResource = schema.GroupVersionResource{Group: "submarine.k8s.io", Version: "v1alpha1", Resource: "foos"}

var foosKind = schema.GroupVersionKind{Group: "submarine.k8s.io", Version: "v1alpha1", Kind: "Foo"}
