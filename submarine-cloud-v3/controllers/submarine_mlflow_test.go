...
func TestSubmarineMlflow(t *testing.T) {
	...
	// test change params
	submarine.Spec.Mlflow.Image = "harbor.com/apache/submarine/" + submarine.Spec.Version
	...
	g.Expect(deployment2.Spec.Template.Spec.Containers[0].Image).To(Equal("harbor.com/apache/submarine/" + submarine.Spec.Version))
