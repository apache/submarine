...
class SubmarineClient(object):
    ...
    def log_metric(self,
        ...
        :param experiment_id: The job name to which the metric should be logged.
        ...
        self.store.log_metric(id, metric)

    def log_param(self, experiment_id, key, value, worker_index):
        """
        Log a parameter against the job name. Value is converted to a string.
        :param experiment_id: The job name to which the parameter should be logged.
        ...
        self.store.log_param(experiment_id, param)
