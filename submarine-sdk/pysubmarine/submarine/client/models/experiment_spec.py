...
class ExperimentSpec(object):
    ...
    openapi_types = {
        ...
        'experiment_handler_spec': 'dict(str, str)',
        'meta': 'ExperimentMeta',
    ...
    attribute_map = {
        ...
        'experiment_handler_spec': 'experimentHandlerSpec',
        'meta': 'meta',
        'spec': 'spec',
    }
    ...
    def __init__(
        ...
        self._experiment_handler_spec = None
        self._meta = None
        self._spec = None
        ...
        if experiment_handler_spec is not None:
            self.experiment_handler_spec = experiment_handler_spec
        if meta is not None:
            self.meta = meta
        if spec is not None:
            self.spec = spec
    ...
    @property
    def experiment_handler_spec(self):
        """Gets the experiment_handler_spec of this ExperimentSpec.  # noqa: E501


        :return: The experiment_handler_spec of this ExperimentSpec.  # noqa: E501
        :rtype: dict(str, str)
        """
        return self._experiment_handler_spec

    @experiment_handler_spec.setter
    def experiment_handler_spec(self, experiment_handler_spec):
        """Sets the experiment_handler_spec of this ExperimentSpec.


        :param experiment_handler_spec: The experiment_handler_spec of this ExperimentSpec.  # noqa: E501
        :type: dict(str, str)
        """

        self._experiment_handler_spec = experiment_handler_spec
