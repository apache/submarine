...
public class TestLocalizableResource {
  ...
  public void testLocalResourceParsing() throws IOException, ParseException {
    ...
    LocalizableResource resource
        = new LocalizableResource("tony-core/src/test/resources/test.zip", fs);
    ...
    LocalizableResource resource2
        = new LocalizableResource("tony-core/src/test/resources/test.zip::ok.123", fs);
    ...
    LocalizableResource resource3
        = new LocalizableResource("tony-core/src/test/resources/test.zip::ok#archive", fs);
    ...
    LocalizableResource resource4
        = new LocalizableResource("tony-core/src/test/resources/test.zip#archive", fs);
